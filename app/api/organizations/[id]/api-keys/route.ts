...
async function withDependencies(
  ...
  try {
    ...
    return await handlerFactory(dependencies)(request, context);
  } catch {
...
export async function GET(
  ...
  return withDependencies(request, context, createApiKeyListHandler);
}
...
export async function POST(
  ...
  return withDependencies(request, context, createApiKeyCreateHandler);
}
