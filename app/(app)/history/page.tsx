  ...
  return (
    <div className="mx-auto max-w-5xl">
      <div className="flex flex-col gap-5 border-b border-white/[0.08] pb-8 md:flex-row md:items-end md:justify-between">
        <div>
          <p className="font-mono text-[0.68rem] uppercase tracking-[0.24em] text-cyan-200/80">Historial local</p>
        ...
        <span className="rounded-full border border-cyan-200/20 bg-cyan-200/[0.05] px-3 py-2 font-mono text-[0.62rem] uppercase tracking-[0.15em] text-cyan-100/80">Solo navegador</span>
      </div>

      {isLoading ? <p className="mt-8 text-sm text-slate-500">Cargando historial local…</p> : null}
